...
const SERVER_ORDER = ['main', 'agg', 'pansilu', 'vidsrc', 'vidlink', 'embed2', 'cdn'];
const PROVIDER_WARNINGS = {
  pansilu: 'Aura may redirect you or open popups. Continue only if you trust this provider.',
