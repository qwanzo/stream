        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-300 font-bold text-sm tracking-wider">PANSILU STREAM</span>
              <span className="text-[10px] text-gray-500 font-normal border border-zinc-800 px-2 py-0.5 rounded">stream.pansilu.cc.cd</span>
            </div>
